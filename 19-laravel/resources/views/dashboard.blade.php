...
@section('content')
    ...
    <div class="flex flex-wrap gap-4 items-center justify-center mb-6">
            ...
            <div class="card-body">
                ...
                <ul class="list bg-[#0003] rounded-box shadow-md">
                    ...
                    <li class="list-row">
                        ...
                        <button class="btn btn-square btn-ghost">
                            {{ App\Models\Pet::whereRaw('LOWER(kind) = ?', ['dog'])->count() }}
                        </button>
                    </li>
                    <li class="list-row">
                        <div>
                        ...
                        <button class="btn btn-square btn-ghost">
                            {{ App\Models\Pet::whereRaw('LOWER(kind) = ?', ['cat'])->count() }}
                        </button>
                    </li>
                    </ul>
                <div class="card-actions justify-end">
            ...
            <div class="card-body">
                ...
                <ul class="list bg-[#0003] rounded-box shadow-md">
                    ...
                    <li class="list-row">
                        ...
                        <button class="btn btn-square btn-ghost">
                            {{ App\Models\Pet::where('adopted', 1)->whereRaw('LOWER(kind) = ?', ['dog'])->count() }}
                        </button>
                    </li>
                    <li class="list-row">
                        <div>
                        ...
                        <button class="btn btn-square btn-ghost">
                            {{ App\Models\Pet::where('adopted', 1)->whereRaw('LOWER(kind) = ?', ['cat'])->count() }}
                        </button>
                    </li>
                    </ul>
                <div class="card-actions justify-end">
                <a class="btn btn-outline hover:bg-[#fff6] hover:text-white mt-3" href="{{ route('adoption.index') }}">
                    Enter
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
                        <path d="M221.66,133.66l-72,72a8,8,0,0,1-11.32-11.32L196.69,136H40a8,8,0,0,1,0-16H196.69L138.34,61.66a8,8,0,0,1,11.32-11.32l72,72A8,8,0,0,1,221.66,133.66Z"></path>
                    </svg>
        ...
        {{-- Customer --}}
        @if(strcasecmp((string) Auth::user()->role, 'Customer') === 0)
        {{-- Module My Profile --}}
        <div class="card text-white bg-[#0006] w-96 shadow-sm">
                <figure class="h-[240px]">
                <img
            ...
            <div class="card-body">
                ...
                <div class="card-actions justify-end">
                <a class="btn btn-outline hover:bg-[#fff6] hover:text-white mt-3" href="{{ route('myprofile') }}">
                    Enter
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
                        <path d="M221.66,133.66l-72,72a8,8,0,0,1-11.32-11.32L196.69,136H40a8,8,0,0,1,0-16H196.69L138.34,61.66a8,8,0,0,1,11.32-11.32l72,72A8,8,0,0,1,221.66,133.66Z"></path>
                    </svg>
        ...
        <div class="card text-white bg-[#0006] w-96 shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="card-actions justify-end">
                <a class="btn btn-outline hover:bg-[#fff6] hover:text-white mt-3" href="{{ route('adoption.create') }}">
                    Enter
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
                        <path d="M221.66,133.66l-72,72a8,8,0,0,1-11.32-11.32L196.69,136H40a8,8,0,0,1,0-16H196.69L138.34,61.66a8,8,0,0,1,11.32-11.32l72,72A8,8,0,0,1,221.66,133.66Z"></path>
                    </svg>
